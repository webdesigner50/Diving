...
// css
    // Swiper CSS
	wp_enqueue_style( 'swiper-css', '//cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.css', array(), '1.0.1', 'all' );
...
// js
    ...
    // Swiper JS
	wp_enqueue_script( 'swiper-js', '//cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js', array( 'jquery' ), '1.0.1', true );
