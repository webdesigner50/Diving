...
?>
      ...
      <section class="site-map layout-site-map">
        <div class="site-map__inner inner">
          <div class="site-map__footer footer footer--site-map">
            <nav class="footer__nav footer-nav footer-nav--site-map">
              <div class="footer-nav__left">
                <ul class="footer-nav__left-items">
                  <li class="footer-nav__left-item footer-nav__left-item--site-map">
